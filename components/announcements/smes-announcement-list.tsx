...
import { Calendar, Building2, MapPin, RefreshCw, AlertCircle, ChevronRight, Bookmark, TrendingUp } from 'lucide-react'
...
export function SMESAnnouncementList() {
  ...
  const getDeadlineBadge = (endDate: string | null) => {
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          <Badge variant="default" className="bg-blue-600">중소벤처24</Badge>
      ...
      {data.length === 0 ? (
        ...
        data.map((item) => {
          const area = extractArea(item.content)
