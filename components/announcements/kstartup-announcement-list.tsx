...
import { ExternalLink, Calendar, Building2, RefreshCw, AlertCircle, Rocket } from 'lucide-react'
...
export function KStartupAnnouncementList() {
  ...
  const fetchData = async () => {
    ...
    try {
      const response = await fetch('/api/announcements/kstartup?limit=50')
          ...
          <Card key={item.id} className="hover:shadow-md transition-shadow">
            ...
            <CardContent>
              <div className="flex flex-wrap gap-2 mb-3">
                ...
                <Badge variant="secondary">창업지원</Badge>
              </div>
